...
class ShowMoreReviewButton extends StatelessWidget {
  final Color? boxColor;
  final Gradient? boxGradient;
  final void Function()? onTap;

  const ShowMoreReviewButton({super.key,  this.boxColor, this.boxGradient, this.onTap});
    ...
    return
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: boxColor,gradient: boxGradient,
